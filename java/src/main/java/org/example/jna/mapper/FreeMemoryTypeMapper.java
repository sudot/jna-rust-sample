 ...
 * 示例:
 * <pre>
 * RustInterface rust = NativeProxy.load(args[0], RustInterface.class);
 *
 * String value = rust.echoString(new GoString(json));
 * System.out.println("rust.echoString :" + value);
 *
 * WString echo2 = rust.echoWString(new GoString(json));
 * System.out.println("rust.echoWString :" + echo2.toString());
 * </pre>
 *
